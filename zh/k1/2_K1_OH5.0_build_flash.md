...
2. 将所有的 `d4281000` 修改为 `d4280000`
   ...
   ```
3. 重新编译固件
4. 烧录方式参考[《TitanFlasher 工具使用手册》](https://www.spacemit.com/community/document/info?lang=zh&nodepath=tools/user_guide/flasher_user_guide.md) “卡启动” 章节。
...
TitanFlasher 烧录工具的使用方法和下载连接如下：[点我查看](https://www.spacemit.com/community/document/info?lang=zh&nodepath=tools/user_guide/flasher_user_guide.md)
