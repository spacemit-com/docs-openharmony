...
- [K1 组合 P1 电源域介绍](#k1-组合-p1-电源域介绍)
- [1. 检查并关闭无用模块和外设](#1-检查并关闭无用模块和外设)
- [2. 调整 CPU 和 DDR 频率](#2-调整-cpu-和-ddr-频率)
- [3. 关闭模块和外设](#3-关闭模块和外设)
- [4. OpenHarmony 平台功耗测试的其他小 tips](#4-openharmony-平台功耗测试的其他小-tips)

> **说明**：本文中的寄存器地址、设备节点和 DTS 示例与具体 SDK、产品板卡及内核版本有关。执行写寄存器、修改 DTS 或关闭系统服务前，请确认目标设备和备份方案。
